/*Downloaded from https://www.codeseek.co/johanmouchet/confetti-party-mojs-qpjavE */
...
function partyPopper(selector, debug) {
	...
	var torsadeBurst = new mojs.Burst(_extends({}, burst, {
		children: _extends({}, torsade)
	}));

	var bentBurst = new mojs.Burst(_extends({}, burst, {
		children: _extends({}, bent)
	}));

	var flakeBurst = new mojs.Burst(_extends({}, burst, {
		children: _extends({}, flake)
	}));
